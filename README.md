...
- [oposSom-Browser](https://www.izbi.uni-leipzig.de/opossom-browser/), for exploring datasets through the lens of "high-dimensional data portraying", generated via self-organizing maps (e.g. through oposSOM). Demo instance available at https://apps.health-atlas.de/opossom-browser/ (source not available?)
